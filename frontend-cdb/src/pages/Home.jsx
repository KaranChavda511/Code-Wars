...
import VoiceAssistant from "../components/Gemini/VoiceAssistant.jsx";
import "./Home.css";
    ...
    <div className="home-container">
      <section className="hero-section">
        ...
        <p className="hero-subtitle">
          Hone your coding skills by solving challenges and competing with
      ...
      <section className="how-it-works">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>
              Fix broken code snippets and sharpen your problem-solving skills
              in a practical way.
            </p>
          </div>
          <div className="step">
            ...
            <p>
              Join exciting real-time multiplayer matches and climb your way to
              the top.
            </p>
          </div>
          <div className="step">
            ...
            <p>
              Get recognized on the leaderboard and build a strong coding
              profile.
            </p>
          </div>
        </div>
